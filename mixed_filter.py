...
if __name__ == "__main__":
    for SNR in range(5, 100, 5):
        ...
        noise_dir = ".\\grayscale\\addnoise\\mixed_noise\\" + str(SNR) + "\\"
        filter_dir = ".\\grayscale\\filter\\mixed_filter\\" + str(SNR) + "\\"
        ...
        for file_name in os.listdir(noise_dir):
            ...
            img_best = cv2.GaussianBlur(img_best, (9, 9), 0)
            psnr_best = PSNR(img0, img_best)
            ssim_best = SSIM(img0, img_best)
